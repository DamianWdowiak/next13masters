...
export type GenericMorph = Category | Collection | I18NLocale | Product | UploadFile | UploadFolder | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser;
...
export type ProductListItemFragment = { id?: string | null, attributes?: { name: string, description: string, price: number, slug: string, images: { data: Array<{ attributes?: { url: string, alternativeText?: string | null } | null }> }, categories?: { data: Array<{ id?: string | null, attributes?: { name: string, slug: string } | null }> } | null } | null };

export type ProductListItemAttributesFragment = { name: string, description: string, price: number, slug: string, images: { data: Array<{ attributes?: { url: string, alternativeText?: string | null } | null }> }, categories?: { data: Array<{ id?: string | null, attributes?: { name: string, slug: string } | null }> } | null };

export type CollectionGetListQueryVariables = Exact<{ [key: string]: never; }>;


export type CollectionGetListQuery = { collections?: { data: Array<{ id?: string | null, attributes?: { name: string, slug: string, image: { data?: { attributes?: { url: string } | null } | null } } | null }> } | null };
...
export type CollectionGetProductsListQuery = { collections?: { data: Array<{ id?: string | null, attributes?: { name: string, description: string, slug: string, products?: { data: Array<{ id?: string | null, attributes?: { name: string, description: string, price: number, slug: string, images: { data: Array<{ attributes?: { url: string, alternativeText?: string | null } | null }> }, categories?: { data: Array<{ id?: string | null, attributes?: { name: string, slug: string } | null }> } | null } | null }> } | null } | null }> } | null };
...
export type ProductGetByIdQuery = { product?: { data?: { id?: string | null, attributes?: { name: string, description: string, price: number, slug: string, images: { data: Array<{ attributes?: { url: string, alternativeText?: string | null } | null }> }, categories?: { data: Array<{ id?: string | null, attributes?: { name: string, slug: string } | null }> } | null } | null } | null } | null };
...
export type ProductsGetListQuery = { products?: { data: Array<{ id?: string | null, attributes?: { name: string, description: string, price: number, slug: string, images: { data: Array<{ attributes?: { url: string, alternativeText?: string | null } | null }> }, categories?: { data: Array<{ id?: string | null, attributes?: { name: string, slug: string } | null }> } | null } | null }>, meta: { pagination: { pageCount: number } } } | null };
...
export type ProductsGetListByNameQuery = { products?: { data: Array<{ id?: string | null, attributes?: { name: string, description: string, price: number, slug: string, images: { data: Array<{ attributes?: { url: string, alternativeText?: string | null } | null }> }, categories?: { data: Array<{ id?: string | null, attributes?: { name: string, slug: string } | null }> } | null } | null }>, meta: { pagination: { total: number } } } | null };
...
export const ProductListItemAttributesFragmentDoc = new TypedDocumentString(`
  ...
  slug
    ...
    `, {"fragmentName":"ProductListItemAttributes"}) as unknown as TypedDocumentString<ProductListItemAttributesFragment, unknown>;
